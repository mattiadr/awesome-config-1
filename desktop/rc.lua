...
-----------------------------------------------------------------------------------------------------------------------
local mymenu = require("desktop.menu-config") -- load file with menu configuration
mymenu:init({ env = env })
...
-- Key bindings
-----------------------------------------------------------------------------------------------------------------------
local hotkeys = require("desktop.keys-config") -- load file with hotkeys configuration
...
-----------------------------------------------------------------------------------------------------------------------
local autostart = require("desktop.autostart-config") -- load file with autostart application list
