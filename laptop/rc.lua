...
-----------------------------------------------------------------------------------------------------------------------
local mymenu = require("laptop.menu-config") -- load file with menu configuration
mymenu:init({ env = env })
...
-- Key bindings
-----------------------------------------------------------------------------------------------------------------------
local hotkeys = require("laptop.keys-config") -- load file with hotkeys configuration
...
-----------------------------------------------------------------------------------------------------------------------
local autostart = require("laptop.autostart-config") -- load file with autostart application list
