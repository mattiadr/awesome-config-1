...
function env:init()
	...
	if beautiful.naughty then
		utable.replace_with(
			...
			redflat.util.table.merge(beautiful.naughty.base, beautiful.naughty.normal)
		)
		utable.replace_with(
			naughty.config.presets.critical,
			redflat.util.table.merge(beautiful.naughty.base, beautiful.naughty.critical)
		)
		utable.replace_with(
			naughty.config.presets.low,
			redflat.util.table.merge(beautiful.naughty.base, beautiful.naughty.low)
		)
		...
		naughty.config.presets.low.height, naughty.config.presets.low.width = nil, nil
	end
end
